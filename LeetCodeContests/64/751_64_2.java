/*
751. IP to CIDR My SubmissionsBack to Contest

Difficulty: Easy
Given a start IP address ip and a number of ips we need to cover n, return a representation of the range as a
list (of smallest possible length) of CIDR blocks.
