...
weight_needed = read_int()
val_A, weight_A = read_ints()
val_B, weight_B = read_ints()

if weight_A + weight_B < weight_needed:
    print(val_A + val_B)
else:
    if weight_A < weight_needed:
        if val_A > val_B:
            print(val_A)
        elif weight_B < weight_needed:
            print(val_B)
        else:
            print(val_A)
