...
r = Nodes(3)
insert_bst(r, Nodes(7))
insert_bst(r, Nodes(1))
insert_bst(r, Nodes(5))
insert_bst(r, Nodes(31))
insert_bst(r, Nodes(13))
...
print("Height :" ,BST_height(r))
print(validate_BST(r))
print(LCA_in_BST(r, 5,31).data)
delete_a_Node_solution2(r, 7)
pre_order_traverse(r)
'''
print(max_in_path_from_a_to_b(r, 1, 13))
print(min_in_path_from_a_to_b(r, 1, 13))
